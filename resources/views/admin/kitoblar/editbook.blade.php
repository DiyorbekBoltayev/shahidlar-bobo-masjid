...
@section('content')
    ...
    <div class="container d-flex justify-content-center">
        ...
        <form action="{{route('updatebook',$data->id)}}" method="post" class="w-50" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label ">Book Nomi</label>
                <input type="text" name="nomi" class="form-control text-black" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->nomi}}" required >
            </div>

            <div class="form-floating">
                <label for="floatingTextarea2" name="matn" >Book autor </label>
                <textarea  name="muallifi" class="form-control text-black" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 300px">{{$data->avtor}}"</textarea>
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                ...
                <input type="file" name="kitob" class="form-control text-black" id="exampleInputPassword1">
            </div>
