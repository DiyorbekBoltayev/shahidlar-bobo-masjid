...
<section class="engine"><a href="#">develop free website</a></section><section class="content6 cid-t34gYhZK46" id="content6-2w">
                        ...
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">
                                    ...
                                    <a href="{{url('maqolasingle',$dat->id)}}" class="text-primary">Ba'tavsil..</a></p>
                            </div>
                        </div>
            </div>
...
<section class="footer4 cid-t2SUykaqip" once="footers" id="footer4-2u">
