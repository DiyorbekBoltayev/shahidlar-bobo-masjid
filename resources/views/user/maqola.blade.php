...
@section('content')
    ...
    <section class="engine"><a href="https://mobirise.info/k">how to develop own website</a></section><section class="features5 cid-t34g4hC3u6" id="features6-2q">
                ...
                <div class="card col-12 col-lg-6">
                    <div class="card-wrapper mbr-flex">
                        <div class="card-box align-left">
                            ...
                            <div class="mbr-section-btn"><a href="page7.html#content6-2w" class="btn btn-primary display-4">Learn more</a></div>
                        </div>
    ...
    <section class="features5 cid-t34g8MM7vB" id="features6-2r">
