...
<section class="menu menu2 cid-t2SPQuvcYh" once="menu" id="menu2-k">

    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            <div class="navbar-brand">
                <span class="navbar-logo"><a href="/">
                        <img style="width: 90px; height: 92px !important; ; " src="{{asset('sss.png')}}" alt="logo" style="height: 5.9rem;">
                    </a>
                </span>
                    ...
                    <li class="nav-item" style="margin-right: -10px; margin-left: -10px;">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{url('videos')}}">Video galereya</a>
