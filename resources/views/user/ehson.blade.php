        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                ...
                <div class="col-md-12 col-lg-12 d-flex justify-content-center mb-4 mt-4 align-items-center" >
                    ...
                    <a href="https://payme.uz/fallback/merchant/?id=61fa825bb0159dc2d9e439dd" class="btn btn-outline-primary  display-4" style=" margin-left: 5%; margin-right: 5%; padding: 5px;">
                        <img style="width: 170px; height: 70px;" src="https://camo.githubusercontent.com/c97f81e877cebd758ea17c0e3c270f955490cd3114c8d01d453d10826309181a/68747470733a2f2f63646e2e706179636f6d2e757a2f646f63756d656e746174696f6e5f6173736574732f7061796d655f30312e706e67" alt="Payme orqali">
                    </a>
                </div>
                <hr class="line">
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img style="" src="/imgehson/{{$d->img}}" alt="rasm">
                        </div>
                    </div>
