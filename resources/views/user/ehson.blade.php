                        ...
                        <div class="card-box">
                            <div class="row">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <div class="mbr-section-btn"><a href="page3.html#contacts2-1s" class="btn btn-primary display-4">Ehson qilish</a></div>
                                </div>
                                <div></div>
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="card-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="{{asset('/assets/images/product2.jpg')}}" alt="Mobirise">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
...
<section class="features8 cid-t2U80JRKJ1" xmlns="http://www.w3.org/1999/html" id="features9-1d">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-6">
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="">Orqaga</a>
                    <a class="btn btn-primary display-4" href="">Oldinga</a></div>
            </div>
        </div>
    </div>
</section>
