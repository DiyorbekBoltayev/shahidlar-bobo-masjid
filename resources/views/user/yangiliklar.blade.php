...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            ...
                            <div class="mbr-section-btn mt-3"><a class="btn btn-warning display-4" href="page5.html#content4-29"><span class="mobi-mbri mobi-mbri-arrow-next mbr-iconfont mbr-iconfont-btn"></span>Learn more</a></div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="image-wrapper">
                            <img src="{{asset('/assets/images/sq2.jpg')}}" alt="Mobirise">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="content-wrapper">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6">
                        <div class="image-wrapper">
                            <img src="{{asset('/assets/images/sq1.jpg')}}" alt="Mobirise">
                        </div>
                    </div>
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            ...
                            <div class="mbr-section-btn mt-3"><a class="btn btn-primary display-4" href="page5.html#content4-29"><span class="mobi-mbri mobi-mbri-arrow-next mbr-iconfont mbr-iconfont-btn"></span>
                                    Learn more
                                </a></div>
                        </div>
                    </div>
    ...
    <section class="features15 cid-t2Ul1NhCdG" id="features16-24">
    ...
    <section class="features16 cid-t2Ul2rvGkd" id="features17-25">
